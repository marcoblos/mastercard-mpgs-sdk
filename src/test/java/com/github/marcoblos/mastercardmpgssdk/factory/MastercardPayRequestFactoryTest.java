 ...
 *
 */
public class MastercardPayRequestFactoryTest {

	@Test
	public void create_pay_object_with_success() {
		MastercardRequestDTO dto = buildSuccessPayRequestDTO();
		MastercardAPIRequest request = MastercardPayRequestFactory.build(dto);
		...
		Assert.assertEquals(request.getApiOperation(), MastercardAPIOperationType.PAY);
	...
	private MastercardRequestDTO buildSuccessPayRequestDTO() {
